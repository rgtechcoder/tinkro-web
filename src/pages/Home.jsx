            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <img 
                  ...
                  className="rounded-2xl shadow-2xl relative z-10 animate-float w-full max-w-md" 
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                We make robotics education accessible, engaging, and fun for every student.
              </p>
            </motion.div>
          ...
          <div className="container mx-auto px-4">
             <div className="grid md:grid-cols-2 gap-12 items-center">
                <motion.div
                  ...
                  className="relative"
                >
                    <img alt="Unleash Your Child's Creativity with Tinkro" class="rounded-2xl shadow-xl w-full" src="https://images.unsplash.com/photo-1651421433361-2c45e7f3e801" />
                </motion.div>
                 <motion.div
                  initial={{ opacity: 0, x: 30 }}
                  whileInView={{ opacity: 1, x: 0 }}
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <p className="text-lg mb-8 text-gray-600 max-w-3xl mx-auto">
               ...
               <img alt="Tinkro product lineup" class="rounded-2xl shadow-xl mx-auto mt-8 max-w-4xl" src="https://images.unsplash.com/photo-1518314916381-77a37c2a49ae" />
              <Button
                size="lg"
